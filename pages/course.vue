<template>
  <NuxtLayout name="course">
    <div class="section section-secondary flex flex-col items-center">
      <div class="mb-6 prose dark:prose-h1:text-slate-50 dark:prose-h2:text-slate-400">
        <h2 v-if="isLogin">Hello {{ name }}</h2>
      ...
      <div class="flex flex-row justify-center flex-grow">
        <div class="bg-white prose mr-4 p-8 min-w-[20ch] max-w-[30ch] flex flex-col rounded-lg shadow-md transition-colors">
          <h3>Chapters</h3>
          <div class="flex flex-col mb-4" v-for="chapter in course.chapters">
...
const { isLogin, name } = useUserData()
</script>
